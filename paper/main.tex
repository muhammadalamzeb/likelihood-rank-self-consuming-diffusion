...
Source, configs, seeds, and logs:
\url{https://github.com/muhammadalamzeb/likelihood-rank-self-consuming-diffusion}
(commit recorded at submission time on the \texttt{master} branch).
